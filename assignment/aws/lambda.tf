...
locals {
  function_names    = ["Assemble", "Process", "Split"]
  function_paths    = ["tmp/Assemble.zip", "tmp/Process.zip", "tmp/Split.zip"]
  function_runtimes = ["python3.8", "python3.8", "python3.8",]
  function_handlers = [
    "lambda_function.lambda_handler", "lambda_function.lambda_handler", "lambda_function.lambda_handler"
  ]
  function_layers   = [[], [], []]
}
